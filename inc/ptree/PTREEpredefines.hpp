...
#define PTREE_VERSION                ((ASIT_VERSION_MAJOR<<16)|(PTREE_VERSION_MINOR<<8)|(FDX_VERSION_PATCH)|(FDX_VERSION_STATE << 24))

#define PTREE_VERSION_CHECK(PTREE_VERSION_MAJOR, PTREE_VERSION_MINOR, FDX_VERSION_PATCH, FDX_VERSION_STATE) \
    (((PTREE_VERSION_MAJOR)<<16)|((PTREE_VERSION_MINOR)<<8)|(PTREE_VERSION_PATCH)|((FDX_VERSION_STATE) << 24))
